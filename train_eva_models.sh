...
python probcal/training/train_model.py --config config/train/eva/eva_faithful_gaussian_cfg.yaml
...
python probcal/training/train_model.py --config config/train/eva/eva_beta_scheduler_gaussian_cfg.yaml
echo "evaluating beta scheduler gaussian model..."
python eva_eval_script.py --config configs/eval/eva_beta_scheduler_gaussian_eval_cfg.yaml
echo "training and eval for the beta scheduler gaussian model done!"

echo "training the natural guassian model..."
python probcal/training/train_model.py --config config/train/eva/eva_natural_gaussian_cfg.yaml
