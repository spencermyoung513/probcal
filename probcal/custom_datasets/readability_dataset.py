...
class ReadabilityDataset(Dataset):
    """Pytorch implementation of the CommonLit readability dataset, hosted at https://www.commonlit.org/blog/introducing-the-clear-corpus-an-open-dataset-to-advance-research-28ff8cfea84a/."""
    ...
    def __init__(
        ...
        """Create an instance of the Readability dataset.

        Args:
            root_dir (str | Path): Root directory where dataset files are stored.
    ...
    def _get_instances_df(self) -> pd.DataFrame:
        ...
        return full_instances[mask][["text", "bt_easiness"]]

    def __getitem__(self, idx: int) -> tuple[str, int]:
        row = self.instances.iloc[idx]
        return row["text"], row["bt_easiness"]
